...
git add| Neste comando deve-se adicionar o nome do arquivo ou diretório que deseja passa para a área de preparação para serem comitados posteriormente|`git add`; Resultado de quando utiliza o comando especificando o arquivo:{}
git commit -m ""
